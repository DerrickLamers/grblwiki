NOTE: HANG TIGHT! THE WIKI IS BEING UPDATED!!!
...
<p align="center">![Official Supporters](https://dl.dropboxusercontent.com/u/2221997/Contributors.png)
</p>_Grbl is an open-source project and fueled by the free-time of our intrepid administrators and altruistic users. If you'd like to donate, all proceeds will be used to help keep this project sustainable and to fund supporting equipment. Thank you!_
...
- G2 and G3 arcs do not accept the P word for tracing multiple full circle arcs.
- G0 and G1 are accepted with no axis words to set the motion mode and feed rate. Common on industrial machines.
